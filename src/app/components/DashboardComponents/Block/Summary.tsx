...
import { getFinancialsPastFiveYears } from "../../DashboardData";
export const SummaryData = ({
  ...
  return (
    <Tabs defaultValue="risk">
        ...
        <Card x-chunk="dashboard-05-chunk-3">
          <CardHeader className="px-7">
            ...
            >
              <ul id="heading">
                <li className="text-lg font-semibold mb-1">APPLE Inc.</li>
                <li className="text-md font-bold mb-1">Earnings </li>
                <li className="text-sm mb-2">
                  Risk factors in an annual report outline possible events,
                  conditions, or uncertainties that may adversely affect a
                  company&apos;s business, financial condition, results of
        ...
        <Card x-chunk="dashboard-05-chunk-3">
          <CardHeader className="px-7">
            ...
            >
              <ul id="heading">
                <li className="text-lg font-semibold mb-1">APPLE Inc.</li>
                <li className="text-md font-bold mb-1">Valuation </li>
                <li className="text-sm mb-2">
                  Risk factors in an annual report outline possible events,
                  conditions, or uncertainties that may adversely affect a
                  company&apos;s business, financial condition, results of
        ...
        <Card x-chunk="dashboard-05-chunk-3">
          <CardHeader className="px-7">
            ...
            >
              <ul id="heading">
                <li className="text-lg font-semibold mb-1">APPLE Inc.</li>
                <li className="text-md font-bold mb-1">Key Drivers </li>
                <li className="text-sm mb-2">
                  Risk factors in an annual report outline possible events,
                  conditions, or uncertainties that may adversely affect a
                  company&apos;s business, financial condition, results of
      ...
      <TabsContent value="EconomicAnalysis">
        <Card x-chunk="dashboard-05-chunk-3">
          <CardHeader className="px-7">
            <CardTitle>Insights</CardTitle>
            <CardDescription>
            ...
            >
              <ul id="heading">
                <li className="text-lg font-semibold mb-1">APPLE Inc.</li>
                <li className="text-md font-bold mb-1">
                  Economic/Industry Analysis
                </li>
                <li className="text-sm mb-2">
                  Risk factors in an annual report outline possible events,
        ...
        <Card x-chunk="dashboard-05-chunk-3">
          <CardHeader className="px-7">
            ...
            >
              <ul id="heading">
                <li className="text-lg font-semibold mb-1">APPLE Inc.</li>
                <li className="text-md font-bold mb-1">Conclusion</li>
                <li className="text-sm mb-2">
                  Risk factors in an annual report outline possible events,
                  conditions, or uncertainties that may adversely affect a
                  company&apos;s business, financial condition, results of
